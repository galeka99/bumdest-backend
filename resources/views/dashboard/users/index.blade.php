...
<div class="flex flex-col p-4">
  <div class="flex flex-row justify-between items-center mb-3">
    <span class="text-xl text-blue-600 font-bold uppercase">Users</span>
    <form action="{{ request()->url() }}" method="GET">
      <div class="form-group">
        <div class="input-group">
          <i class="input-group-text mdi mdi-magnify"></i>
          <input type="text" id="search" name="q" placeholder="Search for Users.." class="form-control form-control-sm" value="{{ request()->input('q') }}">
        </div>
      </div>
    </form>
  </div>
